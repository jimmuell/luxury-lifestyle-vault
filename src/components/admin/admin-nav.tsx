...
import {
  ...
  ScrollText, BookOpen, Mail, FlaskConical, ChevronDown, LineChart, Presentation, HelpCircle, SlidersHorizontal, Newspaper, MousePointerClick, Database, FileText, Tag,
} from 'lucide-react'
...
const NAV_GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/admin/data-room', label: 'Data Room', icon: Database },
    ],
  },
  {
    label: 'Finance',
